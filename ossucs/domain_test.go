...
// HTTP behaviour is covered in ossucs_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "ossucs://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("ossucs", "about")
	if err != nil || got.String() != "ossucs://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want ossucs://page/about", got.String(), err)
	}
}
