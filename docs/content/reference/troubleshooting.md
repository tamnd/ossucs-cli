...
Most of these come down to network reality or how ossucs serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

ossucs rate-limits like any public site. ossucs already paces
...
Where a surface is gated, ossucs reads a cookie or token you supply
...
`ossucs`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ossucs actually did
